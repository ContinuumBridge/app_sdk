...
class UnicodeIO(stdio.StandardIO):

    def write(self, data):
        # Convert to ascii, otherwise twisted/internet/abstract FileDescriptor complains
        data = data.encode('ascii', 'ignore')
        #print "data is", data
        #print "data type is", typeof data
...
class PipedREPL(object):
    ...
    def setup_cb(self):
        #self.namespace['test'] = "Testing!"
        #runpy.run_path(self.bootstrap, init_globals=self.namespace)
        execfile(self.bootstrap, self.namespace, self.namespace)
    ...
    def start(self):
        ...
        self.stdio = UnicodeIO(self.server_protocol)
